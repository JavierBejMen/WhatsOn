...
<div class="container-fluid px-md-5 classTertiaryBackgroundColor" id="idEventsMain">
    <div class="classAllEventsList">
        ...
        <div class="row">
            <div class="col-12 col-lg-6 col-xl-6 pt-4 classAllEventsEventContainer">
                <div class="card" onclick="loadEventInfoView()"
                    style="background-image: url('./assets/images/salir-con-arte.png')"
                    alt="Imagen del evento Salir con Arte" aria-label="Imagen del evento Salir con Arte">
                    ...
                    <div class="card-body w-100 text-white classAllEventsCardBody">
                        ...
                        <div class="card-subtitle row justify-content-start classCategoriesList"
                            aria-label="Categorías de Lemon Rock">
            ...
            <div class="col-12 col-lg-6 col-xl-6 pt-4 classAllEventsEventContainer">
                <div class="card" onclick="loadEventInfoView()"
                    style="background-image: url('./assets/images/lemon-jazz.jpg')" alt="Imagen del evento Lemon Jazz"
                    aria-label="Imagen del evento Lemon Jazz">
                    <div class="row justify-content-end classEventPrice classCategoriesList mx-2 mt-1">
                        <span class="btn btn-elegant" disabled>Entrada Libre</span>
                    </div>
                    <div class="card-body w-100 text-white classAllEventsCardBody">
    ...
    <div class="classAllEventsList">
        ...
        <div class="row">
            <div class="col-12 col-lg-6 col-xl-6 pt-4 classAllEventsEventContainer">
                <div class="card" onclick="loadEventInfoView()"
                    style="background-image: url('./assets/images/guillermo-crovetto.jpg')"
                    alt="Imagen del evento Guillermo Crovetto" aria-label="Imagen del evento Guillermo Crovetto">
                    <div class="row justify-content-end classEventPrice classCategoriesList mx-2 mt-1">
