    ...
    if (count($arrayOfEvents) > 0) {
        ...
        foreach ($arrayOfEvents as $event) {
            ...
            if (ViewEvents::isFirstEvent($previousDateTimeToCompare, $domDocumentForEventsPerDateList)) {
                ViewEvents::InitializeDomDocumentWithNodesAndPreviousDateTimeToCompare(
                ...
                if ($previousDateTimeToCompare != $eventDate) {
                    print($domDocumentForEventsPerDateList->saveHTML($nodeEventsPerDateList));
            ...
            $domDocumentForEventsPerDateEventContainer = ViewEvents::getDomDocumentForEventsPerDateEventContainer(
