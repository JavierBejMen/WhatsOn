...
if (FormValidatorEvent::isValidEvent(
    ...
    if (HelperFileUpload::isFileUploaded($_FILES[FormValidatorEvent::FORM_FIELD_NAME_IMAGE_FILE])) {
        ...
        // echo "Destination file:  " . var_dump(HelperNavigator::getPhpAbsoluteFilePathFromPhpRelativeFilePath(HelperNavigator::DIR_PATH_EVENTS_IMAGES . "/" . HelperFileUpload::generateDestinationFileName($_FILES[FormValidatorEvent::FORM_FIELD_NAME_IMAGE_FILE]))) . "<br><br>";
        // echo "Was moved file to destination? " . var_dump(HelperFileUpload::moveUploadedFileToDestinationFilePath(
        //     $_FILES[FormValidatorEvent::FORM_FIELD_NAME_IMAGE_FILE],
        //     HelperNavigator::getPhpAbsoluteFilePathFromPhpRelativeFilePath(HelperNavigator::DIR_PATH_EVENTS_IMAGES . "/" . HelperFileUpload::generateDestinationFileName($_FILES[FormValidatorEvent::FORM_FIELD_NAME_IMAGE_FILE]))
        // )) . "<br><br>";
        ...
        HelperFileUpload::moveUploadedFileToDestinationFilePath(
            ...
            HelperNavigator::getPhpAbsoluteFilePathFromPhpRelativeFilePath(HelperNavigator::DIR_PATH_EVENTS_IMAGES . "/"
                . HelperFileUpload::generateDestinationFileName($_FILES[FormValidatorEvent::FORM_FIELD_NAME_IMAGE_FILE]))
        );
    }
}
exit();
