...
if (ValidatorFormEvent::isValidEvent(
    ...
    if (HelperFileUpload::isFileUploaded($_FILES[ValidatorFormEvent::FORM_FIELD_NAME_IMAGE_FILE])) {
    ...
    //     DataRepresentationConversor::DateValueFromUIStringToDataBaseString($_POST[ValidatorFormEvent::FORM_FIELD_NAME_END_DATE]),
    //     DataRepresentationConversor::TimeValueFromUIStringToDataBaseString($_POST[ValidatorFormEvent::FORM_FIELD_NAME_END_TIME]),
    //     $_POST[ValidatorFormEvent::FORM_FIELD_NAME_LOCAL_NAME],
    //     $_POST[ValidatorFormEvent::FORM_FIELD_NAME_LOCAL_ADDRESS],
    //     "0.0",
    //     "0.0",
    //     DataRepresentationConversor::FloatValueFromUIStringToDataBaseString($_POST[ValidatorFormEvent::FORM_FIELD_NAME_TICKET_PRICE]),
    //     DataRepresentationConversor::FloatValueFromUIStringToDataBaseString($_POST[ValidatorFormEvent::FORM_FIELD_NAME_LONG_DRINK_PRICE]),
    //     DataRepresentationConversor::FloatValueFromUIStringToDataBaseString($_POST[ValidatorFormEvent::FORM_FIELD_NAME_BEER_PRICE]),
